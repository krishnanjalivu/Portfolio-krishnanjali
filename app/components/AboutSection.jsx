  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        ...
        <li>Web Development by Angela Yu - Udemy</li>
      </ul>
    ),
  },
];
  ...
  return (
    <section className="text-white pt-8" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-7 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <Image src="/images/main.png" width={500} height={500} className="rounded-lg" />
        <div className="border-[#33353F] border rounded-md p-5  mt-4 md:mt-0 text-left flex flex-col h-full">
